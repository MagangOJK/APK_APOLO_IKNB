...
st.set_page_config(page_title="Klasifikasi Kendala APOLO IKNB", layout="wide")
...
status_text.text("5/5: Mapping ke topik...")
            label_to_topik = {
                ...
                2: 'Panduan Upload & Penamaan Laporan',
                3: 'Validasi & File Excel',
                4: 'Pemantauan dan Pelaporan Realisasi Rencana Bisnis '
            }
        ...
        st.download_button(
            ...
            data=excel_data,
            file_name='hasil_lengkap_APOLO_IKNB.xlsx',
